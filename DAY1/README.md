In the following document we have tried classifying some of the prominent open source AI models and defined both working and principle for the same. The models feautred in the document are:
GPT
